...
func TestCompareStringGreaterThan(t *testing.T) {
	rulesConfig, collectorConfig, _ := hpsfprovider.GetParsedConfigsFromFile(t, "testdata/compare_string_greater_than.yaml")
	...
	assert.Equal(t, "Sample_All_1", rule.Name)
	assert.Len(t, rule.Conditions, 1)
	assert.Equal(t, []string{"version"}, rule.Conditions[0].Fields)
	assert.Equal(t, ">", rule.Conditions[0].Operator)
	assert.Equal(t, "1.0.0", rule.Conditions[0].Value)
	assert.Equal(t, "string", rule.Conditions[0].Datatype)
}

func TestCompareStringGreaterThanOrEqual(t *testing.T) {
	rulesConfig, collectorConfig, _ := hpsfprovider.GetParsedConfigsFromFile(t, "testdata/compare_string_greater_than_or_equal.yaml")
	...
	assert.Equal(t, []string{"version"}, rule.Conditions[0].Fields)
	assert.Equal(t, ">=", rule.Conditions[0].Operator)
	assert.Equal(t, "2.0.0", rule.Conditions[0].Value)
	assert.Equal(t, "string", rule.Conditions[0].Datatype)
}

func TestCompareStringLessThan(t *testing.T) {
	rulesConfig, collectorConfig, _ := hpsfprovider.GetParsedConfigsFromFile(t, "testdata/compare_string_less_than.yaml")
	...
	assert.Equal(t, "Sample_All_1", rule.Name)
	assert.Len(t, rule.Conditions, 1)
	assert.Equal(t, []string{"priority"}, rule.Conditions[0].Fields)
	assert.Equal(t, "<", rule.Conditions[0].Operator)
	assert.Equal(t, "medium", rule.Conditions[0].Value)
	assert.Equal(t, "string", rule.Conditions[0].Datatype)
}

func TestCompareStringLessThanOrEqual(t *testing.T) {
	rulesConfig, collectorConfig, _ := hpsfprovider.GetParsedConfigsFromFile(t, "testdata/compare_string_less_than_or_equal.yaml")
	...
	assert.Equal(t, []string{"priority"}, rule.Conditions[0].Fields)
	assert.Equal(t, "<=", rule.Conditions[0].Operator)
	assert.Equal(t, "high", rule.Conditions[0].Value)
	assert.Equal(t, "string", rule.Conditions[0].Datatype)
}
