...
func TestAllowOnlyTheseFields(t *testing.T) {
	// Test the HPSF parsing and template generation using typed configuration
	rulesConfig, collectorConfig, errors := hpsfprovider.GetParsedConfigsFromFile(t, "allow_only_these_fields.yaml")
	...
	expectedTransformProcessor := "transform/Field_Allowlist"
